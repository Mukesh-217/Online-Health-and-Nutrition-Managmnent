                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-down m-0">
                            ...
                            <a href="about.html" class="dropdown-item">About Our Page</a>
                            <a href="about.html" class="dropdown-item">404 Page</a>
                        </div>
                    </div>
                    <a href="courses.html" class="nav-item nav-link">Online Store</a>
                    <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-down m-0">
                            <a href="clogin.jsp" class="dropdown-item">Customer Login</a>
                            <a href="mlogin.jsp" class="  dropdown-item">Mentor Login</a>
                            <a href="alogin.jsp" class="dropdown-item">Admin Login</a>
                        </div>
                    </div>      
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-sm-10 col-lg-8">
                                    ...
                                    <h1 class="display-3 text-white animated slideInDown">We provide you the Best Doctors.</h1>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-sm-10 col-lg-8">
                                    ...
                                    <h1 class="display-3 text-white animated slideInDown">Get the Best Nutrities Diet from Home.</h1>
                                    <p class="fs-5 text-white mb-4 pb-2">Vero elitr justo clita lorem. Ipsum dolor at sed stet sit diam no. Kasd rebum ipsum et diam justo clita et kasd rebum sea sanctus eirmod elitr.</p>
                                    <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">HGet Started</a>
                                    <a href="" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Join Now</a>
                                </div>
                            </div>
                        </div>
